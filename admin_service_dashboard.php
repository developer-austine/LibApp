    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div class="leftinnerdiv">
                ...
                <Button class="greenbtn" onclick="openpart('addperson')"> <img class="icons" src="images/icon/add-user.png" width="30px" height="30px"/> ADD STAFF</Button>
                <Button class="greenbtn" onclick="openpart('studentrecord')"> <img class="icons" src="images/icon/monitoring.png" width="30px" height="30px"/> STAFF REPORT</Button>
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="BSIT"/>Family Law<div style="margin-left:80px"><input type="radio" name="branch" value="BSCS"/>Criminal Law<input type="radio" name="branch" value="BSSE"/>Civi Law</div>
            </div>   
            ...
            <select name="type" >
                ...
                <option value="teacher">Paralegal</option>
            </select>
            ...
            <Button class="greenbtn" >STAFF RECORD</Button>
...
<br>
            <label for="Select Student">Select Staff:</label>
